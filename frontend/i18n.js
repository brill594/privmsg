...
export const messages = {
  zh: {
    ...
    composer: {
      ...
      bodyCounter: (count, limit) => `${count} / ${limit} 字`,
      attachmentsLabel: "附件",
      chooseFiles: "选择文件",
      expiresLabel: "未读失效时间",
      ...
      createdWithPassword: (maxReads) => `消息已创建。最多可成功读取 ${maxReads} 次，接收方还需先输入你设置的密码，服务端才会下发密文。`,
      copied: "链接已复制到剪贴板。",
      copyFailed: "无法直接访问剪贴板，请手动复制链接。",
      noFiles: "尚未选择附件。",
      selectedFiles: (count, size) => `已选择 ${count} 个附件，总计 ${size}。`,
      passwordProtectionTitle: "访问密码（可选）",
      passwordProtectionHint: "设置后，接收方必须先输入此密码，服务端才会返回消息密文、附件密文和解密授权。",
      accessPasswordLabel: "访问密码",
      accessPasswordPlaceholder: "留空则不启用额外密码门槛",
      accessPasswordConfirmationLabel: "确认访问密码",
      accessPasswordConfirmationPlaceholder: "再次输入相同密码",
      enhanced: {
        toggleLabel: "增强加密",
    ...
    reader: {
      ...
      fetching: "正在获取密文…",
      enterPassword: "这条消息设置了访问密码，请先输入密码。",
      ...
      passwordPromptTitle: "输入访问密码",
      passwordPromptBody: "这条消息启用了可选访问密码。请先输入正确密码，服务端才会返回密文内容。",
      passwordPromptLabel: "访问密码",
      passwordPromptPlaceholder: "输入发送方单独提供的密码",
      passwordPromptCancel: "取消",
      passwordPromptConfirm: "确认并继续",
      ...
      errors: {
        ...
        readFailed: "读取失败。",
        passwordRequired: "未输入访问密码，无法继续获取密文。",
        invalidPassword: "访问密码错误，请重新输入。",
        invalidPasswordChallenge: "服务端返回的访问密码校验参数无效。",
  ...
  en: {
    ...
    composer: {
      ...
      bodyCounter: (count, limit) => `${count} / ${limit} chars`,
      ...
      createdWithPassword: (maxReads) =>
        `Message created. Share the full link. It can be opened up to ${maxReads} time(s), and the recipient must enter the password before the server releases the ciphertext.`,
      ...
      passwordProtectionTitle: "Access password (optional)",
      passwordProtectionHint:
        "When set, the recipient must enter this password before the server returns the message ciphertext, attachment ciphertext, and decryption authorization.",
      accessPasswordLabel: "Access password",
      accessPasswordPlaceholder: "Leave blank to disable the extra password gate",
      accessPasswordConfirmationLabel: "Confirm access password",
      accessPasswordConfirmationPlaceholder: "Enter the same password again",
      enhanced: {
    ...
    reader: {
      ...
      enterPassword: "This message is password protected. Enter the password first.",
      ...
      passwordPromptTitle: "Enter the access password",
      passwordPromptBody:
        "This message uses the optional access-password gate. Enter the correct password before the server returns the ciphertext.",
      passwordPromptLabel: "Access password",
      passwordPromptPlaceholder: "Enter the password shared by the sender",
      passwordPromptCancel: "Cancel",
      passwordPromptConfirm: "Confirm and continue",
      ...
      errors: {
        ...
        passwordRequired: "No access password was entered, so the ciphertext cannot be requested.",
        invalidPassword: "The access password is incorrect. Try again.",
        invalidPasswordChallenge: "The server returned an invalid password-challenge payload.",
